...
## Timeline
- **Friday, September 20 11:59pm** Create a gradescope submission for your assignment with all group members.
- **Thursday, September 26 11:59pm** Submit your final assignment on Gradescope
- **Friday, September 27 11:59pm** Submit your reflections on Gradescope.
- **Tuesday, October 1 11:59pm** Submit your peer feedback on Gradescope.
...
Once you have chosen your group, please create a submission on Gradescope with all group members by **Friday, September 20**. 
...
**For at least one variable** perform either a predictive or inferential analysis that illustrates something that we can conclude from that variable. For example, this could mean estimating the likelihood of some future value or testing a hypothesis about the population mean of that variable.
...
- [ ] Perform some kind of **single-variable analysis** In your report discuss the asumptions used in each analysis and the conclusion.
...
**Pose a question.** Consider a continuous/ordinal variable that you visualized in the previous part. Determine a question that you could answer using a model of this variable. In this case we'll restrict it to asking about the likelihood of some future outcome.
