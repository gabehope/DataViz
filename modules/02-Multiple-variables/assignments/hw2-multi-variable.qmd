...
Assignments should follow the homework [Quarto/Jupyter template](https://github.com/gabehope/DataViz-Homework-Template). Each submission should be rendered as HTML and submitted through Canvas. 
